...
def audio_to_audio_frame_stack(sound_data, frame_length, hop_length_frame):
    ...
    # print(sound_data.shape, hop_length_frame)
...
def audio_files_to_numpy(audio_numpy, sample_rate, frame_length, hop_length_frame, min_duration):
    ...
    y = audio_numpy 
    if len(y) < 8064:
        y = np.concatenate((y, np.zeros(8064-len(y))))
    ...
    if (total_duration >= min_duration):
        ...
        print(
            "The following file is below the min duration")
